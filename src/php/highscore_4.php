<?php
	...
	switch ($_REQUEST['command']){
		...
		case "get_scores":
			...
			$template = "SELECT display_name,score FROM `kugel2-4` ORDER BY score DESC LIMIT :number OFFSET :offset";
		...
		case "add_score":
			...
			$template = "INSERT INTO `kugel2-4` (unique_user_name, display_name, score) ";
